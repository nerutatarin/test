...
public class BotTelega extends TelegramLongPollingBot {
            ...
            switch (str) {
                case COMMAND_START:
                    ...
                    String startText = "/add добавить заметку (шаблон: /add title text)\n" +
                            ...
                            "/list список заметок\n";
                    message.setChatId(userId).setText(startText);
                    break;
                ...
                case COMMAND_ADD:
                    ...
                    try {
                        ...
                        message.setChatId(userId).setText("Заметка добавлена!");
                    } catch (Exception e) {
                ...
                default:
                    message.setChatId(userId).setText(str);
            }
 ...
 /*           if (str.startsWith(COMMAND_ADD)) {
            ...
            } else if (str.equals(COMMAND_START)) {
                String startText = "/add добавить заметку (шаблон: /add title text)\n" +
                        "/del удалить заметку (шаблон: /del id) где id номер заметки\n" +
                        "/list список заметок\n";
                message.setChatId(userId).setText(startText);
